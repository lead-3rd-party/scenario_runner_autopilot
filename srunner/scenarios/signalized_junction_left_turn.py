...
class SignalizedJunctionLeftTurn(JunctionLeftTurn):
    ...
    def _initialize_actors(self, config, add_scenario_type=True):
        ...
        if add_scenario_type:
            ...
            CarlaDataProvider.active_scenarios.append(ActiveScenario(type(self).__name__, first_actor=self._source_wp, last_actor=self._sink_wp, scenario_id=id(self))) # added
